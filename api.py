...
class Country(Resource):
    ...
    def put(self,country_id):
        ...
        if country_id <= len(COUNTRIES):
            ...
            country["country"] = args["country"] if args["country"] is not None else country["country"]
            country["city"] = args["city"] if args["city"] is not None else country["city"]
            return country,200
        else:
